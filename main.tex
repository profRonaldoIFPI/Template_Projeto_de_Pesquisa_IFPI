...
A introdução de um projeto de pesquisa deve apresentar o tema de forma clara e contextualizada, demonstrando sua relevância no cenário atual. Conforme o \citeonline{IFPI_Manual_2024}, este capítulo tem como objetivo situar o leitor no contexto da investigação, apresentando a problematização, a justificativa e a delimitação do objeto de estudo.
...
O referencial teórico constitui a base conceitual da pesquisa, apresentando as teorias, conceitos e estudos que fundamentam a investigação. Conforme exposto por \citeonline{IFPI_Manual_2024}, este capítulo destina-se a detalhar as leituras e embasamentos teóricos que sustentam a proposta, explicando, classificando e demonstrando o estado da arte do objeto de estudo.

\section{TÍTULO DA SEÇÃO TEÓRICA}
...
O tamanho da amostra foi calculado considerando [CRITÉRIOS DE CÁLCULO], resultando em [NÚMERO] participantes/elementos.
