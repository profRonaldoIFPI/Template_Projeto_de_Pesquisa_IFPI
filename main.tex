...
\begin{table}[htbp]
    ...
    \label{tab:orcamento}
    \begin{tabular}{p{6cm} d{3.0} d{3.2} d{3.2}}
        \hline
        \textbf{Item} & \textbf{Quantidade} & \textbf{Valor Unitário (R\$)} & \textbf{Valor Total (R\$)} \\
        \hline\hline
        Material de escritório & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} & \num{150,00} \\
        % \hline
        Impressões e cópias & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} & \num{100,00} \\
        % \hline
        Transporte & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} & \num{200,00} \\
        % \hline
        Software (licenças) & \multicolumn{1}{c}{--} & \multicolumn{1}{c}{--} & \num{300,00} \\
        \hline
        \textbf{TOTAL} & & & \textbf{\num{750,00}} \\
        \hline
    \end{tabular}
